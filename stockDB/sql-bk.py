...
class SQLBackup:
    ...
    # def run(self):
    #     self.backup_sql_script_from_container(container_name="db")
    #     # self.push_mysql_image(
    #     #     container_name="mysql-stock2", repo="liulirun/mysql-stock2"
    #     # )

    def backup_sql_script_from_container(self, container_name):
...
if __name__ == "__main__":
    b = SQLBackup()
    b.backup_sql_script_from_container(container_name="db")
